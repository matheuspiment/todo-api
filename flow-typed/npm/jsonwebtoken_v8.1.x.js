...
declare interface jwt$Sign {
  <P: jwt$Encodable>(payload: P, secretOrPrivateKey: string | Buffer): string;

  <P: jwt$Encodable>(payload: P, secretOrPrivateKey: string | Buffer, callback: jwt$Callback): string;

  <P: jwt$Encodable, H>(payload: P, secretOrPrivateKey: jwt$Key, options: jwt$SigningOptionsWithAlgorithm<H>): string;

  <P: jwt$Encodable, H>(
    payload: P,
    secretOrPrivateKey: string | Buffer,
    options: $Shape<jwt$SigningOptions<H>>,
  ): string;
  ...
  <P: jwt$Encodable, H>(
    ...
    secretOrPrivateKey: string | Buffer,
    options: $Shape<jwt$SigningOptions<H>>,
    callback: jwt$Callback,
  ): string;

  <P: jwt$Encodable, H>(
    payload: P,
    secretOrPrivateKey: jwt$Key,
    options: jwt$SigningOptionsWithAlgorithm<H>,
    callback: jwt$Callback,
  ): string;
}
...
declare interface jwt$Decode {
  ...
  (
    jwt: string,
    options: jwt$DecodingOptions & { complete: true },
